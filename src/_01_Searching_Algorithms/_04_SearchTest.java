...
class _04_SearchTest {
	...
	public void testBinarySearch() {
		...
		int[]  nums = {1, 3, 4,5,6};
		assertEquals(3,_01_BinarySearch.binarySearch(nums, 0, 4, 5));
		assertEquals(2,_01_BinarySearch.binarySearch(nums, 0, 4, 4));
		assertEquals(-1,_01_BinarySearch.binarySearch(nums, 0, 4, 7));
	}
	...
	public void testInterpolationSearch() {
		...
		int[] nums = {1,2,3};
		assertEquals(1,_02_InterpolationSearch.interpolationSearch(nums, 2));
		assertEquals(-1,_02_InterpolationSearch.interpolationSearch(nums, 4));
	...
	public void testExponentialSearch() {
		...
		assertEquals(-1,_03_ExponentialSearch.exponentialSearch(nums, 4));
